...
class TestUserService(BaseTestCase):
    ...
    def test_users(self):
        """ ensures that /ping routes behave correctly """
    ...
    def test_single_user(self):
        ...
        user = add_user('michael', 'michael@mherman.org', 'mypwd')
        with self.client:
    ...
    def test_all_users(self):
        ...
        add_user('michael', 'michael@mherman.org', 'mypassword')
        add_user('fletcher', 'fletcher@notreal.com', 'mypwd')
        with self.client:
    ...
    def test_add_user_invalid_json_keys_no_pwd(self):
        """
